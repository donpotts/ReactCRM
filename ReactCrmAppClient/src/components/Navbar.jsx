  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-10 bg-gray-800 bg-opacity-90 backdrop-blur-sm shadow-lg p-4 flex justify-between items-center text-white">
      <div className="flex items-center">
        {isAuthenticated && (currentPage === 'home' || currentPage === 'grid' || currentPage === 'customers' || currentPage === 'addresses' || currentPage === 'productCategories' || currentPage === 'serviceCategories' || currentPage === 'contacts' || currentPage === 'opportunities' || currentPage === 'leads' || currentPage === 'products' || currentPage === 'services' || currentPage === 'sales' || currentPage === 'vendors' || currentPage === 'supportCases' || currentPage === 'todoTasks' || currentPage === 'rewards' || currentPage === 'success') && (
          <button
